...
# Build the v0.1.8 downloadable zip from the explicit distribution manifest
package:
    mkdir -p downloads
    rm -f downloads/justfile-beginner-runbook-v0.1.8.zip
    zip -q downloads/justfile-beginner-runbook-v0.1.8.zip -@ < distribution-manifest.txt
    unzip -t downloads/justfile-beginner-runbook-v0.1.8.zip
